...
try:
    ...
    # Tomar una muestra del 10% si hay datos
    ...
    print(f"Datos GPS cargados: {len(df_gps)} registros (muestra 10%)")
...
# Definir el clasificador base (sin parámetros ajustados todavía)
base_rf = RandomForestClassifier(random_state=42)

# Parámetros a explorar en GridSearchCV
param_grid = {
...
grid_search = GridSearchCV(
    ...
    scoring="f1_weighted",    # métrica que pondera el F1 por el soporte de cada clase
    cv=cv,
...
if best_rf is not None and not X_test.empty:
    ...
    print("No se pudo evaluar el modelo porque falta best_rf o X_test está vacío.")
